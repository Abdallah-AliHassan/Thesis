...
urlpatterns = [
    ...
    # Abdallah Visualizations ############################################################################
    path('getSharedWordsNumber/', views.TotalSharedWordsNumberView.as_view()),
    path('getTotalSharedAuthorsEvolution/', views.TotalSharedAuthorsEvolutionView.as_view()), 
    path('AuthorsPapersEvolutio/<pk1>/', views.AuthorsPapersEvolutionView.as_view()), 
    path('EventPapers/<pk1>', views.ConfEventPapers.as_view()),
    path('confEvents/<pk1>', views.confEvents.as_view()),
    path('topTopicsInYears/<pk1>/<pk2>', views.topWordsOverYears.as_view()),
    path('comparePapers/<pk1>/<pk2>/<pk3>/<pk4>', views.ComparePapersView.as_view()),
    path('compareWordsInPapers/<pk1>/<pk2>/<pk3>', views.getPapersOfWords.as_view()),
    path('commonAuthors/<pk1>/<pk2>', views.CommonAuthorsview.as_view()),
    path('getSharedWordsBar/<pk1>/<pk2>/<pk3>/<pk4>', views.NewconferencesSharedWordsBarView.as_view()),
    path('getSharedWordsBar/<pk1>/<pk2>/<pk3>', views.NewconferencesSharedWordsBarView.as_view()),
    path('eventAuthors/<pk1>', views.AuthorEvents.as_view()), 
    path('AuthorInterestsNew/<pk1>/<pk2>/<pk3>/<pk4>/<pk5>', views.AuthorInterestsBar.as_view()),
    #######################################################################################################
    ...
    path('topicdetails/<pk1>/<pk2>', views.getTopicBarValues.as_view()), #check
    path('conference/<str:pk>/', views.conferenceDeleteView.as_view()), 
    ...
    #TimeLine
    path('getDataTimeLineChart/<pk1>/', views.DataTimeLineChartView.as_view()),
    ...
    path('getabstractdetails/<pk1>/<pk2>/<pk3>', views.FetchAbstractView.as_view()), #ABDO BAB 08.06.2021 Extension for other conferences other than LAK 
