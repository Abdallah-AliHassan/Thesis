  ...
  const handleSelect = (e) => {
    ...
    switch (e.currentTarget.id) {
      ...
      case "compareConferences":
        ...
        break;
      case "EducationalConferences":
        history.push("/app/EducationalConferences");
        break;
    }
  }
    ...
    <>
      ...
      */}
        <ListItem button id="viewConference"
          ...
          <ListItem button id="EducationalConferences"
                    selected={selectedList("EducationalConferences")}
                    onClick={handleSelect}
                    className={selectedList("EducationalConferences")}>
            <ListItemIcon className={classes.listIconNested}>
              <CompareIcon className={selectedList("EducationalConferences")}/>
            </ListItemIcon>
            <ListItemText primary="Educational Data Science Conferences"/>
          </ListItem>
        {/* ///////////////////////////// */}
