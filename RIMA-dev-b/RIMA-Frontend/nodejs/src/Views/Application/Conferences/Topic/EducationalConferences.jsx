...
import NewSilmilarityEvolution from "../../../components/LAKForms/NewSilmilarityEvolution";
...
export default function EducationalConferences (props) {
    ...
    const [mulitSelectDefaultValues, setmulitSelectDefaultValues] = useState([{value: 'lak', label: 'lak'},{value: 'aied', label: 'aied'},{value: 'edm', label: 'edm'}]);
